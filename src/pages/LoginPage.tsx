    ...
    <div className="auth-page">
      ...
      <div className="auth-card-wrap">
        <div className="auth-card">
          ...
          <p className="auth-card-sub">원하는 방식으로 서비스를 시작해보세요</p>
          ...
          <button className="btn-google-auth" onClick={handleGoogle} disabled={isAuthenticating}>
            <svg
          ...
          <button className="btn-guest" onClick={handleGuest} disabled={isAuthenticating}>
            <i className="fa-regular fa-user"></i>
            로그인 없이 사용하기
          </button>

          <p className="auth-notice">
            로그인하면 WaveScan의 <a href="#terms">이용약관</a> 및{' '}
